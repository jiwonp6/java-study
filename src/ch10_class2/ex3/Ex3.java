...
public class Ex3 {
    ...
    메서드:
    borrowBook(): 이 메서드는 도서의 대여 가능 여부(isAvailable)를 확인하고,
                  도서를 대여할 수 있다면 isAvailable을 false로 변경하고 true를 반환합니다.
                  이미 대여 중이라면 false를 반환합니다.
    ...
    public static void main(String[] args) {
        Book book = new Book("노인과 바다", "해밍웨이", "12345678", true);
        Book book1 = new Book("혼자 공부하는 자바", "홍길동");
