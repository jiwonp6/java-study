...
//        executorService.execute(coffeeOrderList.get(0));
//        executorService.execute(coffeeOrderList.get(1));
//        executorService.execute(coffeeOrderList.get(2));
//        executorService.execute(coffeeOrderList.get(3));
//        executorService.execute(coffeeOrderList.get(4));

        coffeeOrderList.forEach(coffeeOrder -> executorService.execute(coffeeOrder));
    ...
    static class CoffeeOrder  implements Runnable {
        ...
        public void run() {
            ...
            String readyMsg = String.format("%s> %s 준비 시작.", threadName, coffeeName);
            String completeMsg = String.format("%s> %s 준비 완료!", threadName, coffeeName);
            try {
