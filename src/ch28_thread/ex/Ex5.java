...
public class Ex5 {
    /*
        ...
        힌트: System.currentTimeMillis()를 사용하여 시작 시간을 기록하고, 각 마법사의 스레드에서 현재 시간이 시작 시간으로부터 얼마나 지났는지 계산하여 마법 사용 여부를 결정합니다. Thread.sleep() 메서드를 사용하여 각 마법사의 마법 사용 간격을 제어할 수 있습니다.
     */
